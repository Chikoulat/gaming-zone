...
function NavBar() {
  ...
  return (
    <section className="bg-navbar bg-no-repeat bg-center xs:h-10 xl:h-36 xl:bg-cover z-10 relative">
      <div className="flex xs:justify-between xl:justify-start xl:gap-28 px-32 3xl:px-80">
        ...
        <div className="xs:mx-auto xl:mx-16">
          <img
            src={logo}
            alt="logo"
            className="xs:w-20 xl:h-24 xl:w-60"
            onClick={() => {
        ...
        <div className="flex items-center gap-2">
          <NavLink
            to="/sing-up"
            className="xs:hidden xl:flex justify-center gap-2 px-10 py-2 bg-button bg-contain bg-center bg-no-repeat text-white"
          >
            <img
          ...
          <NavLink
            to="/login"
            className="xs:hidden xl:flex justify-center gap-2 px-10 py-2 bg-buttonC bg-contain bg-center bg-no-repeat text-white "
          >
            <img
